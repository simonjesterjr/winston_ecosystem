...
# Loop B overnight refresh 2026-09-24 — read-only WUT pull
# Host:
#   cd /home/johnkoisch/Documents/com/sawtooth
#   ./bin/compose cp ecosystem/docs/analysis/_loop_b_overnight_refresh_2026-09-24.rb winston_unit_test:/tmp/loop_b_refresh.rb
...
out = {
  ...
  prior_seed: "2026-09-24-loop-b-overnight-refresh.json",
  today: today.to_s,
