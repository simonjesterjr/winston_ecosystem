...
# Loop B overnight refresh 2026-09-25 — read-only WUT pull
# Host:
#   cd /home/johnkoisch/Documents/com/sawtooth
#   ./bin/compose cp ecosystem/docs/analysis/_loop_b_overnight_refresh_2026-09-25.rb winston_unit_test:/tmp/loop_b_refresh.rb
...
BOOKS.each do |book, meta|
  ...
  highlight_ids = [743, 727, 767, 768, 769, 770, 771]
...
out = {
  ...
  prior_seed: "2026-09-24-overnight-loop-b-refresh.json",
  today: today.to_s,
