...
- `winston_data_manager` `2fa40ac` — fix(alt): raise Congress filing GET limit when from= is set
- `winston_unit_test` `393a49b` — chore(ops): skip DailyTasks on Quiver lab baskets 282–284
- `winston_ecosystem` `68b7e35` — docs: Congress Long-Short copy-book wrap; schedule digest + Friday job
