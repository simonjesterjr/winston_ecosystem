...
**DoD:** Operator has clicked Code cuboids + all three work sub-tabs + opened one ADR under the diagram on both local `:3002` and Tailscale `/wv2/operations/ecosystem`
...
1. Open Code on `http://127.0.0.1:3002/operations/ecosystem` (hard refresh; assets are `?v=20260908c`).
2. Click `dm`: metadata answers what / for / helps Winston / externals (End of Day Historical Data, Quiver Quantitative).
3. Switch **ADRs**, **tickets / issues**, **plans**. Open one ADR — markdown appears **under** the cuboids, not in a new tab.
