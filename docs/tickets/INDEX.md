...
|----------|--------|------|-------|
| P0 | Proposed | [`2026-09-21-option-enter-working-stop-underlying.md`](2026-09-21-option-enter-working-stop-underlying.md) | Option enter Working Stop must stay on the underlying (not premium−2N) — [issue](../issues/2026-09-21-option-enter-working-stop-from-premium.md) · [wrap](../session-reports/2026-09-21-1457-mode-c-furthest-call-desk-uat.md) |
...
| P1 | Proposed | [`2026-09-21-loop-b-60d-forward-label-pipeline.md`](2026-09-21-loop-b-60d-forward-label-pipeline.md) | Loop B — 60d forward OA/Edge label pipeline + scoreboard (PCS depth gap) — [spec](../analysis/2026-09-21-loop-b-60d-forward-labels-feature-table.md) |
...
| P2 | Proposed | [`2026-09-19-leap-instrument-label-occ-vs-ticker.md`](2026-09-19-leap-instrument-label-occ-vs-ticker.md) | LEAP instrument label OCC vs ticker — **needs design session** — [wrap](../session-reports/2026-09-18-1720-mode-c-leap-desk-prefill.md) · SEF/BITQ 2026-09-21 still ticker |
| P2 | Proposed | [`2026-09-21-desk-furthest-month-full-chain.md`](2026-09-21-desk-furthest-month-full-chain.md) | Desk Plan B is ATM-3 of furthest month, not the listed surface — [wrap](../session-reports/2026-09-21-1457-mode-c-furthest-call-desk-uat.md) |
...
| P1 | Done | [`2026-09-20-standard-call-flatten-roll-desk.md`](2026-09-20-standard-call-flatten-roll-desk.md) | Wire standard_call flatten/roll DTE to desk tasks — helper exists |
...
| P1 | In progress | [`2026-09-15-bg-ibkr-opt-order-intent-prove.md`](2026-09-15-bg-ibkr-opt-order-intent-prove.md) | BG OPT Order Intent + IBKR paper 1×1 prove — [plan](../../plans/wv2-bg-ibkr-leap-fulfillment.md) · [ADR-017](../adr/ADR-017-leap-packaging-precalc-occ.md) |
