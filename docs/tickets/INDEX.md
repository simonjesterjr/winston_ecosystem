...
| P1 | In progress | [`2026-09-15-bg-ibkr-opt-order-intent-prove.md`](2026-09-15-bg-ibkr-opt-order-intent-prove.md) | BG OPT Order Intent + paper long-call Day LMT Desk-Send prove (permission Done 2026-09-23; print still open) — [plan](../../plans/wv2-bg-ibkr-leap-fulfillment.md) · [ADR-017](../adr/ADR-017-leap-packaging-precalc-occ.md) · [grill+SC](2026-09-15-bg-ibkr-opt-order-intent-prove.md#grill--sc-checklist-2026-09-23) |
