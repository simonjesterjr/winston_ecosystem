...
| P2 | In progress | [`2026-09-22-dar-mcp-emit-option-fields.md`](2026-09-22-dar-mcp-emit-option-fields.md) | DAR and pending MCP must emit stored option fields — Lane B CLI dry-run |
