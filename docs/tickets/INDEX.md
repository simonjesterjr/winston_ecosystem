...
| P1 | In progress | [`2026-09-24-copper-794-mode-d-paper-bind.md`](2026-09-24-copper-794-mode-d-paper-bind.md) | Copper #794 → new Mode D paper OP (shares TS75 1% caps 3/10) — not #1581 Mode C — [plan](../../plans/copper-794-mode-d-paper-bind.md) |
| P1 | Done | [`2026-09-24-shares-ts75-modified-heat-bakeoff.md`](2026-09-24-shares-ts75-modified-heat-bakeoff.md) | Shares-only TS75 modified-heat bakeoff 788–795 — Edge_R identical to heat-absent control; best Copper #794 0.311; no heat-knob win; no promote |
...
| P1 | Done | [`2026-09-22-min-atr-capital-consumption-guard.md`](2026-09-22-min-atr-capital-consumption-guard.md) | Capital Fit — first-lot diversity reserve + small-ATR max; Wv2 notional cash and WUT short-capacity (not 3× long borrow). Teal USDU 2872 — [SC plan](../../plans/spending-capacity-and-leap-fulfillment.md) · [TF-P3](2026-09-04-tf-p3-live-sizing-and-capital-authority.md) |
