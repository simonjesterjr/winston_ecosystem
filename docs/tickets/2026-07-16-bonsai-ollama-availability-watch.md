...
| 2026-07-18 | **Not available (stock).** Local: no bonsai. Still only community 1-bit `defyma85/bonsai-27b-q1_0` (~1.1k pulls); eslider/bonsai-1.7b still documents stock Ollama cannot load Q1_0. No Ternary-Bonsai-27B Ollama tag. 8B unchanged (`digitsflow/bonsai-8b`, `MichelRosselli/ternary-bonsai`). Status remains Proposed/watch. |
| 2026-07-19 | **Not available (stock).** Local: no bonsai. Unchanged: `defyma85/bonsai-27b-q1_0` (~1.3k pulls, Q1_0); eslider still documents stock Ollama cannot load Q1_0; no Ternary-Bonsai-27B Ollama tag. 8B: `digitsflow/bonsai-8b`, `MichelRosselli/ternary-bonsai`. Status remains Proposed/watch. Scheduler (created 2026-07-16) expires ~2026-07-23 — re-arm soon. |
| 2026-07-20 | **Not available (stock).** Local: no bonsai. New community Q1_0 tag `cyberchrome/Bonsai-27B-Q1_0.gguf` (~58 pulls, tools badge) + existing `defyma85/bonsai-27b-q1_0` (~1.6k); eslider still says stock Ollama cannot load Q1_0. No Ternary-Bonsai-27B Ollama tag. 8B unchanged. Status remains Proposed/watch. **Re-arm scheduler by ~2026-07-23.** |
